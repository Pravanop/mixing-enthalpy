...
class CompositionGrid:
	...
	@staticmethod
	def create_high_sym_mol_grid(change_idx: List[int], x: Iterable, n: int, N: int) -> np.ndarray:
		"""
	...
	@staticmethod
	def create_mol_grid_transmutation(transmutation_indice: List[int], n: int, x:  Iterable) -> np.ndarray:
		"""
