...
def create_vasprun(
	...
	for i in tqdm(loop, desc="Creating Vasp Run") :
...
Example Usage
"""
inp_file_path = "/Users/pravanomprakash/Library/CloudStorage/Box-Box/YbFeO3/Project files/YbFeO3_initial.vasp"
output_folder_path = "/Users/pravanomprakash/Downloads"
create_vasprun(inp_file_path = inp_file_path,
               output_folder_path = output_folder_path,
               metadata_path = "./metadata/metadata_YFO.yaml")